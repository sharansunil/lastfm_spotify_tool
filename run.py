...
main=Data_Plot_Builder(lastfm_username=lastfm_username,sp_username=sp_username,scope=scope,refresh_sp=1,refresh_last_top_albums_artists=1,refresh_last_tracks_pl=1,refresh_playlists=1,refresh_artist=1)
